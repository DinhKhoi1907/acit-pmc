    ...
    <div class="mail-container">
        ...
        <div class="mail-body">
            <div class="mail-content-inform" style="background: no-repeat url({{config('config_all.config_all_url')}}img/mail/logo-mikotech.png) center;background-size: contain;">
                <p class="mail-title">{{($setting) ? $setting['tenvi'] : 'Chúng tôi'}} xin thông báo!<br> Hệ thống phát hiện tài khoản của bạn đang có người muốn thay đổi thông tin , nếu là bạn xin vui lòng sử dụng mã xác thực <strong>{{$user['otp']}}</strong> để xác minh danh tính và cập nhật thông tin.</p>
            </div>
        </div>

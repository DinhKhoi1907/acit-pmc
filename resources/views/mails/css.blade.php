    <style>
        ...
        .mail-table-tindang{border-collapse: collapse; margin-top: 20px ; font-size: 14px;width: 100%;border-radius: 1em; overflow: hidden;/*box-shadow: 0px 0px 5px rgb(0 0 0 / 10%);*/}
        .mail-table-tindang tr td:nth-child(1){font-size: 12px;}
        .mail-table-tindang tr td:nth-child(2){padding-left: 15px;}
        .mail-table-tindang tr td{background: #fafafa; /*border: 1px solid #ebebeb; */padding: 10px;}
        .mail-options{margin-top: 20px;}

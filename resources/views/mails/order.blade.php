    ...
    <div class="mail-main-contain">
        <div class="mail-container">
                ...
                <div class="mail-content-inform" style="//background: no-repeat url({{config('config_all.config_all_url')}}img/mail/logo-mikotech.png) center;background-size: contain;">
                    ...
                    @if(isset($data['order']))
                        <div class="mail-form-inform">
                            <!--THÔNG TIN ĐƠN HÀNG-->
                            <div class="mail-order-title">THÔNG TIN KHÓA HỌC {{ $data['order']['madonhang'] }} <span>(Ngày tạo {{ date('d-m-Y',$data['order']['ngaytao']) }})</span></div>
                            ...
                            <div class="mail-order-title">THÔNG TIN CHI TIẾT</div>
                            <table class="mail-table-ordermain">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3"><strong>{{($data['order']['status_payments']==1) ? 'Đã thanh toán' : 'Chưa thanh toán'}}</strong></td>
                                    </tr>
            ...
            <div class="mail-footer" style="background: #26b99acc;line-height: 1.8;border-bottom: 5px solid #26b99a;">
                <p>{{$setting['tenvi']}}</p>
                <p>Địa chỉ: {{$setting['diachi'.$lang]}}</p>
                <p>

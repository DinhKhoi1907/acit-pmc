                            ...
                            <label for="title{{$k}}" class="inp">
                                ...
                                <div class="label">SEO Title:
                                    <span class="//label-seo miko-label-seo">                                
                                        <strong class="count-seo">(<span>{{ (isset($rowItem['title'.$k])) ? Helper::CountSeo($rowItem['title'.$k]) : '' }}</span>/70 ký tự)</strong>
                                    </span>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="keywords{{$k}}" class="inp">                                
                                ...
                                <div class="label">SEO Keywords:
                                    <span class="//label-seo miko-label-seo">                                
                                        <strong class="count-seo"><span>{{ (isset($rowItem['title'.$k])) ? Helper::CountSeo($rowItem['keywords'.$k]) : '' }}</span>/70 ký tự</strong>
                                    </span>
                                </div>
                                <div class="focus-bg"></div>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="description{{$k}}" class="inp">                            
                                ...
                                <div class="label">SEO Description:    
                                    <span class="//label-seo miko-label-seo">                                
                                        <strong class="count-seo"><span>{{ (isset($rowItem['title'.$k])) ? Helper::CountSeo($rowItem['description'.$k]) : '' }}</span>/160 ký tự</strong>
                                    </span>
                                </div>
                                <div class="focus-bg"></div>
                            </label>

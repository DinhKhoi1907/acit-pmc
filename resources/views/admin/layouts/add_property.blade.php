...
<div class="modal fade" id="modal_property_color" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	            		...
	            		<div class="row modal-color-info">
	            			<div class="form-group col-12">
								<label for="color_tenvi" class="inp">
									<input type="text" class="form-control" name="color[tenvi]" id="color_tenvi" placeholder="&nbsp;" value="">
							...
							@if(isset($config[$type]['mau_mau']) && $config[$type]['mau_mau'] == true)
	                            <div class="form-group col-md-6 col-sm-12">
	                                ...
	                                <input type="text" class="form-control jscolor" name="color[mau]" id="mau" maxlength="7" value="#000000">
	                            </div>
	                        @endif
...
<div class="modal fade" id="modal_property_size" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	            ...
	            <div class="modal-body" id="show_addSize">
	            	...
	            	<div class="form-group col-12 p-0">
						<label for="size_tenvi_0" class="inp">
							<input type="text" class="form-control" name="size[]" id="size_tenvi_0" placeholder="&nbsp;" value="">
...
@push('js')
	<script>
		...
		$('.modal-size-add').click(function(){
			...
			var str_element = '<div class="form-group col-12 p-0"><label for="size_tenvi_'+opposite+'" class="inp"><input type="text" class="form-control" name="size[]" id="size_tenvi_'+opposite+'" placeholder="&nbsp;" value=""><span class="label">Tên size</span></label></div>';

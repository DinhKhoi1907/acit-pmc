<div class="photoUpload-zone">
	...
	@if($request->category=='man')
		<div class="photoUpload-dimension">{{ "Width: ".$config[$type]['width2']*$config[$type]['ratio']." px - Height: ".$config[$type]['height2']*$config[$type]['ratio']." px (".$config[$type]['img_type'].")" }}</div>
	@else

<div class="p-0 mb-3 text-sm card card-primary card-outline">
    <div class="card-header">
        <h3 class="card-title">Danh mục cấp {{$level}}</h3>
    </div>
    <div class="card-body">
        <div class="miko-multy-category-select">
            <i class="far fa-angle-down miko-angle-down"></i>
            <input type="text" value="" data-level="{{$level}}" class="miko-multy-category-list miko-multy-category-list-{{$level}}" placeholder="Chọn danh mục" readonly="">

...
@for($i=0;$i<$amount_images;$i++)
    ...
    <div class="miko-upload-image mb-3" data-toggle="modal" data-target="#modal_upload_image_{{$i}}">
...
<a class="miko-upload-setting" href="{{route('admin.gallery.fileupload')}}" target="_blank"><i class="fas fa-file-upload mr-1"></i> Quản lý thư viện ảnh</a>
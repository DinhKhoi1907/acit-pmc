            ...
            <div class="text-sm card card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control jscolor" name="data[bg_color]" id="bg_color" maxlength="7" value="{{($rowItem['bg_color'])?$rowItem['bg_color']:'#000000'}}">
                    </div>
                    <div class="form-group">
                        <label class="d-block" for="text_color">Màu chữ:</label>
                        <input type="text" class="form-control jscolor" name="data[text_color]" id="text_color" maxlength="7" value="{{($rowItem['text_color'])?$rowItem['text_color']:'#000000'}}">
                    </div>
                </div>
            </div>                
            @endif

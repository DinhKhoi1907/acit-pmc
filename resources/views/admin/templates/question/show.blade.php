	...
	<div class="card-footer text-sm sticky-top">
        <div class="btn dropdown pl-0 ml-1">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">            
            ...
            <a class="btn btn-sm bg-gradient-danger btn-none-css" id="delete-all" data-url="{{ route('admin.question.deleteAll', ['man']) }}" title="Xóa tất cả"><i class="far fa-trash-alt mr-2"></i>Xóa tất cả</a> 
          </div>
        </div>		       
    </div>
        ...
        <div class="col-12">
            <div class="card card-primary card-outline text-sm mb-0">
                <div class="card-header">
                    <div class="form-inline col-sm-3 form-search align-middle mb-3">
                        <div class="input-group input-group-sm">
                            <input class="form-control form-control-navbar text-sm" type="search" id="keyword" placeholder="Tìm kiếm" aria-label="Tìm kiếm" value="{{ (isset($request->keyword))?$request->keyword:'' }}" onkeypress="doEnter(event,'keyword','{{ route('admin.question.show',['man']) }}')">

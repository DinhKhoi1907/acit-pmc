...
@section('content')
	...
	<div class="card-footer text-sm sticky-top">
        ...
        <a class="btn btn-sm bg-gradient-danger text-white" id="delete-all" data-url="{{ route('admin.coupon.deleteAll', ['man', $type]) }}" title="Xóa tất cả"><i class="far fa-trash-alt mr-2"></i>Xóa tất cả</a>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card"> 
                <div class="card-header">
                    <div class="form-inline col-sm-3 form-search d-inline-block align-middle">
                        <div class="input-group input-group-sm">
                            <input class="form-control form-control-navbar text-sm" type="search" id="keyword" placeholder="Tìm kiếm" aria-label="Tìm kiếm" value="{{ (isset($request->keyword))?$request->keyword:'' }}" onkeypress="doEnter(event,'keyword','{{ route('admin.coupon.show',['man', $type]) }}')">

...
<div class="card-footer sticky-top drag-menu-sticky">
	@if(count($menus)!=0)
		...
		<a class="btn btn-sm bg-gradient-primary text-white" href="{{ route('admin.menu.index',['new']) }}" title="Tạo mới menu"><i class="fas fa-plus mr-2"></i>Tạo mới menu</a>
	@endif
</div>
...
<div class="row">
	<div class="col-xl-12">
		@if(config('config_all.menus')==true)
			<div class="card card-primary card-outline text-sm pt-3">
...
<div class="row" id="main-row">
	...
	<div class="col-sm-6 cat-view ml-5">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-2">
										<div class="form-group">	
											<button class="btn btn-sm bg-gradient-danger text-white btn-menu-create">Tạo menu</button>
										</div>
									</div>
								</div>
							</div>
		...
		@else
		    ...
		    @if($desiredMenu != '')
		    <p>
					<a class="btn btn-sm bg-gradient-danger text-white" href="{{route('admin.menu.destroy',[$desiredMenu->id])}}">Xóa Menu</a>

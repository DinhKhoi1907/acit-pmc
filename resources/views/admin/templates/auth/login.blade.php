...
<head>
  ...
  :root {
    ...
    --gradient-primary: linear-gradient(90deg, #1BC1C1 0, #70EFD1 100%);
  }
  ...
  * {
  ...
  .sign-in {
    /* background: rgb(2, 38, 49); */
    /* background: linear-gradient(90deg, rgb(116 235 213 / 40%) 0, rgb(172 182 229 / 40%) 100%); */
    background: url('../img/bg_admin.jpg') no-repeat center;background-size: cover;
    min-height: 100vh;
    position: relative;
    overflow: hidden;
    display: flex;
  ...
  .sign-in:after{content:'';position: absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.8)}
  ...
  <div class="sign-in">
    ...
    <div class="sign-in__content">
      <div class="sign-in__left">
        ...
        {{-- <video src="{{asset('img/admin/HeSinhThaiMikoTech.mp4')}}" muted autoplay></video> --}}
      </div>
      <div class="sign-in__right">
        <div class="sign-in__logo" style="text-align:center;width:40%;">
          {{-- @include('admin.layouts.logo') --}}
          <img style="width:100%" src="{{asset('img/logo_main.png')}}" alt="">
        </div>
        <form class="sign-in__form" action="{{ route('admin.login') }}" method="post">
          @csrf
          {{--
          <div class="hform-control">
            <label for="">Tên đăng nhập</label>
            <div class="hform-control__input">
          ...
          <div class="form-group">
            <label for="username" class="inp">
              <input type="text" class="form-control for-seo" name="username" id="username" placeholder="&nbsp;"
                value="" required="">
          ...
          <div class="hform-control hform-control__input--password form-group">
            <label for="password" class="inp">
              <input type="password" class="form-control for-seo" name="password" id="password" placeholder="&nbsp;"
                value="" required="">
          ...
          <div class="hform-control">
            ...
            <div class="hform-control__input hform-control__input--password">
          ...
          <div class="d-flex justify-content-between align-items-center d-none">
            <label class="hform-control__checkbox" for="save-password">
              Lưu mật khẩu
          ...
          <div class="px-0 col-12">
            <div class="p-2 mt-0 mb-0 text-sm text-center alert my-alert alert-login alert-danger login-alert-danger"
        ...
        <div class="mt-4 sign-in__info">
          {{-- <p>
            <b><span>Tổng đài hỗ trợ khách hàng:</span> 028 3636 8805</b>
          </p>
          <p style="font-style: italic; font-size: 11px">
            Thời gian làm việc: Thứ Hai đến Thứ Sáu (08h30 – 17h30 ), Thứ Bảy (8h30 - 12h30)
          </p>
          <p style="margin-top: 0.8rem;">
            <b><span>Email:</span> support@mikotech.vn</b>
          </p> --}}
          <!-- <p>

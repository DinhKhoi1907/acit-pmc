...
@section('content')
<div class="bg-white border-0 border-t border-solid border-cmain3">
	<div class="login-layout py-28">
		<div class="login-inform-main {{($bg=='bgWarning') ? 'bgWarning' : ''}} {{($bg=='bgError') ? 'bgError' : ''}} {{($bg=='bgSuccess') ? 'bgSuccess' : ''}}">
			<div class="d-none login-icon-inform {{($icon=='successLogin') ? 'successLogin' : ''}}">
			...
			<div class="d-none login-icon-inform {{($icon=='errorLogin') ? 'errorLogin' : ''}}">

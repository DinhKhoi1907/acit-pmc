								...
								@foreach($coin_receip as $k=>$v)	
									...
									<div class="manage-history-item">
										...
										<div class="manage-history-info">
											<div class="manage-history-flex"><p class="manage-history-status">+ {{$v['soxu']}} xu</p> <span class="mx-2">từ tài khoản</span><p class="manage-history-user">{{'@'.$user_tra['name']}}</p></div>

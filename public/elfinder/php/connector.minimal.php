...
//$id_elfinder = (isset($_REQUEST['id_elfinder']) && $_REQUEST['id_elfinder']!='') ? $_REQUEST['id_elfinder'] : '';

$path_elfinder = '../upload/elfinder/'; //   '../../../upload/elfinder/'
if(isset($_REQUEST['id_elfinder'])){
	$path_elfinder = '../upload/elfinder/'.$_REQUEST['id_elfinder']; //   '../../../upload/elfinder/'
}

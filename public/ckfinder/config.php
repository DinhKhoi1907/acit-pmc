...
function url_upload($namefolder=''){
    ...
    $currentPageUrl = $protocol . "://" . $_SERVER["HTTP_HOST"];
    return $currentPageUrl . '/'. $namefolder;
}
$name_url = url_upload('MyProject').'/upload/';
...
$config['licenseName'] = 'localhost'; //domain website

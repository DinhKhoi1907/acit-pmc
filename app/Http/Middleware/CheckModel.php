...
class CheckModel
{
    ...
    public function handle(Request $request, Closure $next, $model)
    {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        $array_model = ['Product', 'Post', 'Album', 'Setting', 'Photo', 'StaticPost', 'Color', 'Size', 'Error', 'ProductOption', 'Member', 'Brand', 'Tags', 'Places', 'Newsletter', 'Contact', 'Order', 'SeoPage', 'Lang', 'Users', 'Category', 'Question', 'DanhGia', 'BinhLuan'];

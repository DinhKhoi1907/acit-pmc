...
class PlaceController extends Controller
{
    //
    use SupportTrait;
	private $category, $type, $table, $viewShow, $viewEdit, $model, $config, $gallery, $permissionShow, $permissionAdd, $permissionEdit, $permissionDelete, $page_error, $other_title;
    ...
    */
    public function Show(Request $request){
        ...
        $params['id_city'] = ($request->id_city) ? $request->id_city : 0;
        $params['id_district'] = ($request->id_district) ? $request->id_district : 0;
        $params['id_wards'] = ($request->id_wards) ? $request->id_wards : 0;

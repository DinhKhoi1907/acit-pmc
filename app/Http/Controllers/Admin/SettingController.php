...
{
    use SupportTrait;
    private $config, $viewShow, $folder_upload;
    private $folder = "user";
    ...
    */
    ...
    public function Index(Request $request){
        ...
        $history_coin = $this->historypayRepo->GetItems(['id_user_nhan'=>0], null, ['ngaytao'=>'desc']);
        ...
        $response = array(
            ...
            'quyuocxu'=>json_decode($rowItem['quyuocxu'],true),
            'type'=> $type,
            'config'=>$this->config,

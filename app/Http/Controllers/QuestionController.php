...
class QuestionController extends Controller
{
    ...
    public function ShowQuestion($response, Request $request){
        ...
        $gallery = $this->photoRepo->GetAllItems('gallery',['hienthi'=>1], null, false, false);

        $row_seo = $banner = $model_seo->GetItem(['type'=>$type]);
        ...
        return view('desktop.templates.photo.gallery')->with($response);
    }
}

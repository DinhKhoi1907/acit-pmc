...
class PhotoController extends Controller
{
    ...
    |--------------------------------------------------------------------------
    */
    public function Show($response, Request $request){
        //### gọi model
        $model = $this->photoRepo;//new StaticPost();
        ...
        //### xử lý
        $row_detail = $banner = $this->seopageRepo->GetItem(['type'=>$type]);
        ...
        $photo = ($row_detail['photo']!='')?Helper::GetConfigBase().UPLOAD_SEOPAGE.$row_detail['photo']:'';

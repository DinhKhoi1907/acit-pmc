...
class ProductProperty extends Model
{
    ...
    */
    ...
    public function BelongPropertyParent() {
        return $this->belongsTo('App\Models\Category','id_property');
    }


    public function BelongProperty() {
        return $this->belongsTo('App\Models\Post','id_value');
    }
    ...
    //     return $this->hasMany('App\Models\Product','ids_level_1');
    // }
    ...
    //     return $this->hasMany('App\Models\Product','ids_level_1')->with('HasProductOptionsAll')->limit(10);
    // }

...
class Album extends Model
{
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    public function HasAllProductsLimit() {
        return $this->hasMany('App\Models\Product','id_bst')->with(['HasProductOptionsAll','Allrating','MaxStar'])->limit(10);
    }
    ...
    |--------------------------------------------------------------------------
    */
    public function HasAllProducts() {
        return $this->hasMany('App\Models\Product','id_bst')->with(['HasProductOptionsAll','Allrating','MaxStar']);
    }
    ...
    */
    public function GetPhotos() {
        return $this->hasMany('App\Models\Gallery','id_photo')->where('type','bosuutap')->where('com','album');//->limit(7);
    }
    ...
    */
    public function GetRelations(){
        return ['HasAllChild','HasAllProductsLimit','HasAllProducts','GetPhotos'];
    }
